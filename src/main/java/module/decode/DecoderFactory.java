...
public class DecoderFactory
{
                                               ...
                                               Channel channel)
  {
    ...
    boolean recordAudio = recordConfig != null && recordConfig.getRecorders().contains(RecorderType.AUDIO);
