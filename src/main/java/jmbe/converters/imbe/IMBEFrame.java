...
public class IMBEFrame
{
  ...
  private void adaptiveSmoothing(int previousTM)
  {
    ...
    for (int l = 1; l <= mModelParameters.getL(); l++)
    {
      ...
      mModelParameters.getVoicingDecisions()[l] =
          ((mModelParameters.getEnhancedSpectralAmplitudes()[l] > VM) || mModelParameters.getVoicingDecisions()[l]);
    ...
    else
    {
      mModelParameters.setAmplitudeThreshold(
          6000 - (300 * mModelParameters.getErrorCountTotal())
              + previousTM);
    }
  ...
  public enum FundamentalFrequency
  {
    ...
    FundamentalFrequency(Harmonic harmonics, double frequency)
    {
  ...
  public enum Harmonic
  {
    ...
    Harmonic(Bands bands, int[][] blockHarmonics,
