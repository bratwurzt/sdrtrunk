...
public class FCD1TunerController extends FCDTunerController
{
   ...
   */
  private void getLNAGainSetting() throws UsbException
  {
   ...
   */
  private void setPhaseAndGainCorrection() throws
      UsbException
  {
   ...
   * @throws UsbException
   */
  private void getPhaseAndGainCorrection() throws
      UsbException
  {
   ...
   */
  private void setDCIQCorrection() throws UsbException
  {
...
//				" correction:" + correction );
  ...
  private void getDCIQCorrection() throws
      UsbException
  {
...
//				  " ICorr:" + mDCCorrectionInPhase );
  ...
  private void getLNAEnhanceSetting() throws UsbException
  {
  ...
  private void getMixerGainSetting() throws UsbException
  {
  ...
  public void setMixerGain(MixerGain gain) throws UsbException
  {
  ...
  public enum LNAGain
  {
    ...
    LNAGain(int setting, String label)
    {
      mSetting = setting;
      mLabel = label;
    }
  ...
  public enum LNAEnhance
  {
    ...
    LNAEnhance(int setting, String label)
    {
      mSetting = setting;
      mLabel = label;
    }
  ...
  public enum MixerGain
  {
    ...
    MixerGain(int setting, String label)
    {
      mSetting = setting;
      mLabel = label;
    }
